...
The method actually used in remote entry devices is somewhat more complicated than the examples described here. For more information about this method, and the history of attacks on it, see \bref{Keeloq}{https://en.wikipedia.org/wiki/KeeLoq}.
...
\fbox{\begin{minipage}{43em}
\begin{center} \large \dotuline{Activity 1: Modular Arithmetic}  \\ \end{center}
...
\fbox{\begin{minipage}{43em}
\begin{center} \large \dotuline{A Different Sort of Rolling Code}  \\ \end{center}
