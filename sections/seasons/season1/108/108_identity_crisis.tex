...
And if you add up all the terms of a geometric progression with ratio $r$, between 0 and 1, then you will obtain,
	\[
	\sum_{i=1}^\infty a_n= ar+ar^2+\cdots+ar^n+\cdots = a\left(\frac{1}{1-r}-1\right)
	\]
